...
let package = Package(
    ...
    targets: [
        ...
        // MARK: - Sync stub. Remote sync engine implementation in Phase 02.
        .target(
        ...
        // MARK: - Audio capture stub. Platform audio framework usage in Phase 03.
        .target(
        ...
        // MARK: - Transcription stub. On-device ML integration in Phase 03.
        .target(
